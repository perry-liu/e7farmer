...
def replace_fodder(fodder_count_to_level):
    ...
    type_list = [WARRIOR_ICON_IMG, KNIGHT_ICON_IMG, THIEF_ICON_IMG, RANGER_ICON_IMG, MAGE_ICON_IMG, SOUL_WEAVER_ICON_IMG]
    ...
    #     count, pt = imagesearch_count(REPLACE_HERO_IMG)
    #     if i == 0:
    #         find_and_click_image(ADD_HERO_IMG)
    #         click_image(REPLACE_HERO_IMG, pt[1])
    #     if i == 1:
    #         find_and_click_image(LEVEL_ONE)
    #         find_and_click_image(ADD_HERO_IMG)
    #         click_image(REPLACE_HERO_IMG, pt[3])
    #     if i == 2:
    #         find_and_click_image(LEVEL_ONE)
    #         find_and_click_image(ADD_HERO_IMG)
    #         click_image(REPLACE_HERO_IMG, pt[2])
    ...
    for i, hero_type in enumerate(type_list):
        ...
        # count, pt = imagesearch_count(REPLACE_HERO_IMG, 0.8)
        # if count == 1:
        #     click_image(REPLACE_HERO_IMG)
        # else:
        #     if fodders_replaced == 0:
        #         click_image(REPLACE_HERO_IMG, pt[1])
        #     if fodders_replaced == 1:
...
def adventure_loop(adventure_type, replenish_energy=False, fodders_to_level=0, remaining_runs=-1):
    ...
    while remaining_runs < 0 or remaining_runs > 0:
        ...
        need_to_replace_fodder = __run_adventure(need_to_replace_fodder, fodders_to_level, replenish_energy, count_dict)
...
if __name__ == '__main__':
    adventure_loop("world_adventure", False)
